...
describe("/counties", function() {
    ...
    describe("POST county progress in time", function() {
        it("should return an object of values for the given county", (done) => {
            request(app)
                .post("/counties/3805/progress")
                .send({
                    "start": "2015-01-01",
                    "end": "2016-01-01"
                })
    ...
    describe("GET county geometry", function() {
        it("should return a GeoJSON", (done) => {
            request(app)
                .get("/counties/3100/geometry")
                .expect(200)
                .end((err, res) => {
                    if (err) {
                        throw err;
